...
class CovidFetchRequest:ObservableObject{
    ...
    @Published var allCoutries: [CountryData] = []
    ...
    func getCurrentTotal() {
        AF.request("https://covid-19-data.p.rapidapi.com/totals",
...
//                print(json)
    ...
    func getAllCountries() {
        ...
        AF.request("https://covid-19-data.p.rapidapi.com/country/all",
            headers: headers).responseJSON { response in
...
//                    print(countryData)
                ...
                self.allCoutries = allCount.sorted(by: { $0.confirmed > $1.confirmed})
            }
        }
    }
}
